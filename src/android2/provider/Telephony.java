...
public final class Telephony {
    private static final String TAG = Telephony.class.getName();

    private static Log Log = com.coleman.util.Config.getLog();
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static final class Intents {
             ...
             * <li><em>data
             * (byte[])</em> - The data payload of the message</li>
             * </ul>
             * <p>
             * If a BroadcastReceiver encounters an error while processing this
             * intent it should set the result code appropriately.
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static long getOrCreateThreadId(Context context, Set<String> recipients) {
            ...
            Cursor cursor = context.getContentResolver()
                    .query(uri, ID_PROJECTION, null, null, null);
            if (DEBUG) {
