...
package com.coleman.kingword.util;
...
/**
 * This class extends <code>InputStream</code>, and delegate
 * <code>RandomAccessFile</code> for some random access operations. So, this
 * class can manipulate file with "high/low level" methods as <b>Stream</b>
 * manipulatation. In other words, we can read(many methods for reading file) or
 * write file <code>byte</code> by <code>byte</code>, or line by line.
 * 
 * @author 88250
...
public class FileAccessor extends InputStream {
     ...
     */
    public FileAccessor(File file, String mode) throws FileNotFoundException {
        randomAccessFile = new RandomAccessFile(file, mode);
    }
