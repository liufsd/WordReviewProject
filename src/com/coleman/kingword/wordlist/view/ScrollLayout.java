...
/**
 * 在布局时用过PageBottomBar和ScrollLayout后，要使PageBottomBar工作，
 * 需要在ScrollLayout中设置PageBottomBar的实例。
 * 
 * @author coleman
 * @version [version, Jun 25, 2012]
...
public class ScrollLayout extends ViewGroup {
    ...
    public void setBottomBar(PageBottomBar btmBar) {
        this.btmBar = btmBar;
        if (btmBar != null) {
            btmBar.setCurScreenIndex(mCurScreen);
        }
    }
    ...
    public void snapToScreen(int whichScreen) {
        ...
        Log.i(TAG, "===coleman-debug-whichScreen: " + whichScreen);
        if (btmBar != null) {
            btmBar.setCurScreenIndex(whichScreen);
        }
    ...
    public boolean onTouchEvent2(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(x - downX) + Math.abs(y - downY) > 50) {
                    moveEvent = true;
                }
                break;
        }
    ...
    /**
     * Invoke by onTouchEvent if don't want to move when reach the end page.
     * 
     * @param deltaX
     * @return
     */
