...
public class SLWrapper
{
    ...
    public static JSONObject wrap(SLRequest<?> slRequest)
            throws IllegalArgumentException, IllegalAccessException,
            JSONException, UnknownTypeException, FieldNotInitException
    {
    ...
    {
        public static JSONObject wrap(Object javaObj)
                throws IllegalArgumentException, IllegalAccessException,
                JSONException, UnknownTypeException, FieldNotInitException
        {
            ...
            for (Field field : fields)
            {
                ...
                Log.v(TAG,
                        javaObj.getClass().getSimpleName() + "."
                                + field.getName() + ": " + field.get(javaObj));
                if (SLTypeChecker.isSimpleType(type))
                {
                    if (type.getName().equals(Date.class.getName()))
                    {
                        jsonObj.put(kn.abbr(),
                                format.format(field.get(javaObj)));
                    }
                    else
                    {
