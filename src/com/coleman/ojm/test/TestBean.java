...
public class TestBean implements BasicResponse {
    @KeyName(abbr = "A")
    ...
    @KeyName(abbr = "IB")
    private InnerBean[] beans = new InnerBean[] {
            new InnerBean(), new InnerBean()
    };

    @Override
    public String toString() {
        return "age:" + age + " date:" + date + " fee:" + fee[0] + "," + fee[1] + "," + fee[2]
                + "...";
    }
    ...
    @Override
    public void setResultCode(Integer rc) {
        // TODO Auto-generated method stub
